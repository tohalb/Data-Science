...
#    alterSum =("""ALTER TABLE %s ADD %s float;""",(table,colname))
    ...
    for ticker_symbol in tickerlist:
        getbuy = ("""update %s s
			...
			and reportdate between '2014-10-01' and '2015-01-31'
			and s.symbol = '%r'
        ...
        and s.reportdate between '2014-10-01' and '2015-01-31'
    ...
    for ticker_symbol in tickerlist:
        pnl = ("""update %s s
            inner join
                ...
                inner join 
				(	
                    select distinct r.symbol, r.reptype, p.pricedate,p.mid, ((r.mid - p.mid)/p.mid)*100 as pnl
                    from prices p,
                    report r
                    where r.symbol= p.symbol
                    and r.symbol = %s
                    and r.reportdate between '2014-10-01' and '2015-01-31'
                    and p.pricedate <= r.reportdate	
#		and p.pricedate between '2014-10-01' and '2015-01-31'
                    LIMIT %d,1
                    )l
                on p.symbol = l.symbol
			and p.pricedate = l.pricedate
			and s.reptype = l.reptype
			and s.reportdate between '2014-10-01' and '2015-01-31'
			and p.pricedate between '2014-10-01' and '2015-01-31'
			and s.symbol = %s
       set s.minus12 = l.pnl""", (table,ticker_symbol,i,ticker_symbol))    
    
#    colname = "minus" + str(i)
#    addcol = "ALTER TABLE %s ADD %s float;", (table, colname)

#addcol = "ALTER TABLE testsum ADD minus1 float;"
#i=i+1
