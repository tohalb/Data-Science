...
#        getbuy6 = getbuy5[:-28]
        ...
        set_hundred = """update %s set %r = 100;""",(table,colname)
        set_hundred2 = '{} {}'.format(*set_hundred )              
        set_hundred3 = set_hundred2.replace("%s",table)
        set_hundred4 = set_hundred3.replace("%r",colname)
        x=len(table)+4+len(colname)+2+2
        set_hundred5 = set_hundred4[:-x]
#        print(set_zero5)
        
        cursor.execute(set_hundred5)  
        cnx.commit()  
#table = 'testsum'
#ticker_symbol = "IBM"    
